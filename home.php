...
<body>
    ...
    <main>
        <div class="container-login container-perfil">
            ...
            <span><img src="assets/images/linha-horizontal-laranja.png" alt="linha horinzontal laranja"
                    ...
                    <div>
                        <img src="assets/images/professor1.jpg" alt="Imagem de um professor(a)"
                            class="imagemProfessor" name="imagemProfessor" id="imagemProfessor">
                            <img src="assets/images/professor2.jpg" alt="Imagem de um professor(a)"
                            class="imagemProfessor" name="imagemProfessor" id="imagemProfessor">
                            <img src="assets/images/professor3.jpg" alt="Imagem de um professor(a)"
                            class="imagemProfessor" name="imagemProfessor" id="imagemProfessor">
                            <img src="assets/images/professor4.jpg" alt="Imagem de um professor(a)"
                            class="imagemProfessor" name="imagemProfessor" id="imagemProfessor">
                            <img src="assets/images/professor5.jpg" alt="Imagem de um professor(a)"
                            class="imagemProfessor" name="imagemProfessor" id="imagemProfessor">
